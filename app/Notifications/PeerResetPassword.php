...
class PeerResetPassword extends Notification implements ShouldQueue
{
    use Queueable;
    public $peer, $token, $value;
     ...
     * @return void
     */
    public function __construct(Peer $peer, $token, $value)
    {
        $this->peer = $peer;
        $this->value = $value;
        $this->token = $token;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->greeting('Hello ' . $this->peer->fullName . ' !')
