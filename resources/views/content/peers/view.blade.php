                                    ...
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <div class="d-flex flex-column ml-1">
                                            <div class="peers mb-1">
                                                <h4 class="mb-0">{{ $peers['fullName'] }}</h4>
                                                <span class="card-text">{{ $peers['email'] }}</span>
                                            </div>
                                            <div class="d-flex flex-wrap">
                                                <a class="btn btn-primary mr-2 my-2"
                                                    href="{{ route('peers.index') }}">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="user-info-wrapper">
                                    <div class="d-flex flex-wrap">
                                        <div class="user-info-title">
                                            ...
                                            <span class="card-text user-info-title font-weight-bold mb-0">Peer Name</span>
                                        </div>
                                        <p class="card-text mb-0">{{ $peers['fullName'] }}</p>
                                    </div>
                                    <div class="d-flex flex-wrap my-50">
                                        ...
                                        <p class="card-text mb-0">{{ $peers['contact_no'] }}</p>
                                    </div>
                                    <div class="d-flex flex-wrap my-50">
                                        <div class="user-info-title">
                                        ...
                                        <p class="card-text mb-0">{{ $peers['dob'] }}</p>
                                    </div>
                                    <div class="d-flex flex-wrap my-50">
                                        <div class="user-info-title">
