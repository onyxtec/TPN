                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" @submit.prevent="submit" method="POST"
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <select class="form-control" v-model="specialization_type"
                                                    id="register-specialization-type" name="specialization-type">
                                                    <option disabled selected>Select Your Specialization</option>
                                                    <option>Mental Health</option>
                                                    <option>Substance Use Disorder</option>
                                                    <option>Both</option>
                                                </select>
                                                <label class="form-label" for="form3Example4c">Peer Specialist
                                                    Specialization</label>
                                            </div>
                                        </div>
                                        <div v-if="specialization_type == 'Substance Use Disorder' || specialization_type == 'Both'"
                                       ...
                                       <a v-bind:href="'login'"
                                            class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">Already Have an Account? SignIn</a>
                                    </form>
                                </div>
