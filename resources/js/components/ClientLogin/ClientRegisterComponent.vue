        ...
        <div class="row ">
            ...
            <div class="col-lg-7">
                <div class="d-flex justify-content-end mx-5 mt-5">
                    <p>Already Have an
                        Account?</p> <a class="ml-2" v-bind:href="'login'"><span style="color:#A136C5">SignIn
                            Instead</span> </a>
                </div>
                ...
                <div class="col-lg-6 offset-lg-3 mt-4">
                    <a class="px-3 py-3 ml-3 rounded peerButton">I'm a
                        Peer</a>
                    <a class="px-3 py-3 rounded clientButton">I'm
                        a Client</a>
                </div>
                <ValidationObserver v-slot="{ handleSubmit }">
                    <form @submit.prevent="handleSubmit(submit)" method="POST" nonvalidate="nonvalidate">
                        ...
                        <div class="col-lg-6 offset-lg-3 mt-4">
                            ...
                            <div class="col-lg-10">
                                <input v-model="email" type="email" class="form-control input-size"
                        ...
                        <div class="col-lg-6 offset-lg-3 mt-4">
                            ...
                            <div class="col-lg-10">
                                <input v-model="contact_no" type="tel" class="form-control input-size"
                        ...
                        <div class="col-lg-6 offset-lg-3 mt-4">
                            ...
                            <div class="col-lg-10">
                                <input v-model="dob" type="date" class="form-control input-size"
                        ...
                        <div class="col-lg-6 offset-lg-3 mt-4">
                            ...
                            <div class="col-lg-10">
                                <input v-model="address" type="text" class="form-control input-size"
                                    placeholder="Address" />
                            </div>
                        </div>
                        <div class="col-lg-6 offset-lg-3 mt-4">
                        ...
                        <div class="col-lg-6 offset-lg-3 mt-4" v-if="problem_type == 'Substance Use Disorder'">
                            <div class="col-lg-12 text-left">
